function [ColHeader,varargout]=mytextreadStr(filename,varargin);
% 
% COLHEADER = MYTEXTREADSTR(FILENAME)
%
% Reads the column headers of files written out by cell2txt, assuming all
% columns are strings.
%
% [ch,field1,field2] = mytextreadStr(filename,{'field1'; 'field2'});
